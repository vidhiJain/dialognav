...
class Goal(WorldObj):
    def __init__(self, color='green', toggletimes=1):
...
class Grid:
    ...
    def render_tile(
        ...
        if agent_dir is not None:
            ...
            tri_fn = rotate_fn(tri_fn, cx=0.5, cy=0.5, theta=math.pi*(agent_dir+90)/180.) #0.5*math.pi*agent_dir)
...
class MiniGridEnv(gym.Env):
    ...
    def __init__(
        ...
        # Whether or not the `done` action is used (not used by default)
